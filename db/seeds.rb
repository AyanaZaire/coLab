...
ruby = User.create(name: "Ruby", skill: "Carpentry, Mason, Plumbing", img_url: "./images/user_img/user2.jpg", bio:"Worked in construction for the past 15 years. I enjoy carpentry work the most because it makes me one with nature.", availability: true)
