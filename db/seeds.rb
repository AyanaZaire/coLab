...
ruby = User.create(name: "Ruby", skill: "Carpentry, Mason, Plumbing", img_url: "https://i.ytimg.com/vi/SbXIj2T-_uk/maxresdefault.jpg", bio:"Worked in construction for the past 15 years. I enjoy carpentry work the most because it makes me one with nature.", availability: true)

alvaro = User.create(name: "Alvaro", skill: "Roofing and Dry-Wall", img_url: "./images/user_img/user4.jpg", bio:"Went into the family construction business when I was 21. Learned all my skills from my father and also went to trade school.", availability: true)

emily = User.create(name: "Emily", skill: "Landscaping, Cement-Mixing, Painter", img_url: "./images/user_img/user16.jpg", bio: "Created my own business at the age of 25 after being an apprentice for a local home builder for 7 years. Mastered the craft of using a paint roller and shovel.", availability: false)
